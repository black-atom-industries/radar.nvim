...
---Get window width for sidebar (fixed or dynamic)
...
function M.calculate_window_width(radar_config)
  ...
  return radar_config.ui.mini.width
end
...
function M.create(radar_config)
  ...
  local width = radar_config.ui.mini.fixed_width and radar_config.ui.mini.width
