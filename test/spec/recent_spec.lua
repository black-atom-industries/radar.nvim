...
describe("recent", function()
    ...
    local function setup_test_state()
        ...
        vim.uv.cwd = function() return "/test/project" end
    ...
    describe("get_files", function()
        ...
        it("excludes locked files", function()
            ...
            state.locks = {{ label = "1", filename = vim.fn.fnamemodify("/test/project/file1.lua", ":p:.") }}
    ...
    describe("track_current_file", function()
        ...
        before_each(function()
            ...
            original_bo = vim.bo
            vim.api.nvim_buf_get_name = function() return "/test/project/current.lua" end
        ...
        it("limits session files to max_session_files", function()
            ...
            for i = 1, test_config.max_session_files do
            ...
            MiniTest.expect.equality(#state.session_files, test_config.max_session_files)
            -- Current file should be at the end
            MiniTest.expect.equality(state.session_files[#state.session_files], "/test/project/current.lua")
        end)
